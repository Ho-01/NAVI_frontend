...
export default class 교태전 extends Phaser.Scene {
    ...
    create() {
        ...
        this.bg = this.add.image(width * 0.5, height * 0.5, "bg_교태전").setOrigin(0.5).setDepth(-1);
        ...
        this.bundleOverlay = new BundleOverlay(this, {
            ...
            onMap: () => this.showMapOverlay("map_교태전"),
        ...
        const 강녕전으로 = this.add.image(width * 0.50, height * 0.90, "icon_아래쪽이동").setOrigin(0.5).setScale(0.4).setVisible(false);
